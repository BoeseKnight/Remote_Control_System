...
class CommandDecoder(Decoder):
    ...
    def decode(self):
        ...
        for outer_command in commands:
            ...
            command_name = code_and_data[0]
            command_data = code_and_data[1]
            # print(command_code + "   " + command_data)
            inner_command = InnerCommand(command_name=command_name,  command_type='OUTER', command_data=command_data,
                                         command_state="in processing")
